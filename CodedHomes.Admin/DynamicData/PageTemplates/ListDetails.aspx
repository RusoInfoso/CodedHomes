<%@ Page Language="C#" MasterPageFile="~/Site.master" CodeBehind="ListDetails.aspx.cs" Inherits="CodedHomes.Admin.ListDetails" %>
            ...
            <asp:Panel ID="DetailsPanel" runat="server">
                ...
                <asp:FormView ID="FormView1" runat="server" DataSourceID="DetailsDataSource" RenderOuterTable="false"
                    ...
                    <ItemTemplate>
                        ...
                        <tr class="td">
                            <td colspan="2">
                                <asp:LinkButton runat="server" CommandName="Edit" Text="Изменить" />
                                ...
                                <asp:LinkButton runat="server" CommandName="New" Text="Новый" />
                            </td>
                        </tr>
                    </ItemTemplate>
                    <EditItemTemplate>
