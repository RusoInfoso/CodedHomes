...
namespace CodedHomes.Admin
{
    public partial class GridViewPager : System.Web.UI.UserControl
    {
        ...
        protected void DropDownListPageSize_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                //Если индекс страницы изменился, это означает, что предыдущая страница была недопустима и была скорректирована. Повторите привязку с учетом скорректированной страницы
                _gridView.DataBind();
            }
        }
